...
module.exports.run = async ({ event, api, args, }) => {
    ...
    try {
        ...
        await global.utils.downloadFile(`https://image.thum.io/get/width/1920/crop/400/fullpage/noanimate/https://osu-sig.vercel.app/card?user=${args[0]}&mode=mania&lang=en&w=2002&h=1165`, path);
